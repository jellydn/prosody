...
interface IntonationTrainingScreenProps {
  exercise: Exercise;
  onNext: () => void;
  onBack: () => void;
...
export default function IntonationTrainingScreen({
  exercise,
  onNext,
  onBack,
  onComplete,
}: IntonationTrainingScreenProps) {
  ...
  const renderIntonationPattern = () => {
    const isQuestion = exercise.targetText.includes("?");
    return (
      <View style={styles.intonationContainer}>
        <Text style={styles.intonationSentence}>{exercise.targetText}</Text>
        <View style={styles.intonationIndicator}>
          <Ionicons
            name={isQuestion ? "arrow-up-circle" : "arrow-down-circle"}
            size={32}
            color={isQuestion ? "#FF9500" : "#007AFF"}
          />
          <Text style={[styles.intonationArrow, isQuestion ? styles.rising : styles.falling]}>
            {isQuestion ? "↗ Rising" : "↘ Falling"}
          </Text>
        </View>
      </View>
    );
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} keyboardShouldPersistTaps="handled">
        <View style={styles.content}>
          ...
          <View style={styles.intonationSection}>
            <Text style={styles.sectionTitle}>Intonation Pattern</Text>
