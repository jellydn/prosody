...
export default function ShadowingModeScreen({
	...
	const stopRecordingAfterDelay = async (
		rec: Audio.Recording,
		delay: number,
	) => {
		if (delay > 0) {
					...
					{!shadowingComplete && (
						<View style={styles.shadowingSection}>
							...
							<Pressable
								...
								style={[
									styles.shadowButton,
									isShadowing && styles.shadowButtonActive,
								]}
							>
								<Ionicons
									name={isShadowing ? "stop" : "mic"}
									size={40}
									color="#fff"
								/>
							</Pressable>
							...
							<View style={styles.playbackRow}>
								<View style={styles.playbackItem}>
									<Pressable
										...
										style={[
											styles.playButton,
											isPlayingModel && styles.playButtonActive,
										]}
									>
										<Ionicons
								...
								<View style={styles.playbackItem}>
									<Pressable
										...
										style={[
											styles.playButton,
											isPlayingUser && styles.playButtonActive,
										]}
									>
										<Ionicons
