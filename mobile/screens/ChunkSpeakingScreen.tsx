...
export default function ChunkSpeakingScreen({
  ...
  const renderChunks = () => {
    if (!exercise.chunks || exercise.chunks.length === 0) {
      return null;
    }
    ...
    return (
      <View style={styles.chunksContainer}>
        {exercise.chunks.map((chunk, index) => (
          <View key={`chunk-${index}`} style={styles.chunkCard}>
      ...
      <ScrollView style={styles.scrollView} keyboardShouldPersistTaps="handled">
        <View style={styles.content}>
          ...
          <View style={styles.chunksSection}>
            <Text style={styles.sectionTitle}>Thought Groups</Text>
            {renderChunks()}
          </View>
